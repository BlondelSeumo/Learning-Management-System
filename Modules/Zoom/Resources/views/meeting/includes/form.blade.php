                    ...
                    <div class="row mt-20 recurrence-section-hide">
                        <div class="col-lg-6">
                            ...
                            <select
                                ...
                                <option data-display="Recurrence type *" value="">{{__('zoom.Student')}}
                                    zoom_recurring_type') *
                                </option>
                                @if (isset($editdata))
                                    <option
...
@endif
@if(isset($editdata))
    <input type="hidden" name="recurrence_section" class="recurrence_section" value="{{old('is_recurring',$editdata->is_recurring)}}">
@else
