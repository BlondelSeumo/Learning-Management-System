...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>{{__('coupons.Personalized Coupons List')}}</h1>
            <div class="bc-pages">
...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
                                ...
                                @if(isset($edit))
                                    @if (permissionCheck('coupons.personalized.store'))
                                        <a href="{{route('coupons.manage')}}"
                                           class="primary-btn small fix-gr-bg"  style="position: absolute;  right: 0;   margin-right: 15px;" title="{{__('coupons.Add')}}">+ </a>
                                    @endif
                                @endif
                            </div>
                        </div>
     ...
     <td>{{@$coupon->title }}</td>
                                        ...
                                        <td>{{@$coupon->totalUsed->count()==0?"No":"Yes" }}</td>
                                        <td>
                                            <!-- shortby  -->
